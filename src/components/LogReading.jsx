...
const LogReading = () => {
  ...
  useEffect(() => {
    ...
    if (sys < 90 || dia < 60) {
      ...
      setStatus('High BP - Stage 2');
    } else if (sys > 180 || dia > 120) {
      setStatus('Hypertensive Crisis');
    } else {
      setStatus('Uncategorized');
    }
  }, [systolic, diastolic]);
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex justify-center items-center p-4">
      <div className="bg-white rounded-3xl shadow-lg w-full max-w-md p-6">
        <h2 className="text-xl font-semibold mb-4">📋 Log New Reading</h2>

        {/* BP Input */}
        <div className="bg-gray-50 p-4 rounded-xl border mb-4">
          <h3 className="text-sm font-medium text-blue-600 mb-2">Blood Pressure Reading</h3>
        ...
        {/* Date and Time */}
        <div className="bg-gray-50 p-4 rounded-xl border mb-4">
          <h3 className="text-sm font-medium text-blue-600 mb-2">📅 Date & Time</h3>
